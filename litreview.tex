...
Epsilon is a suite of languages and tools that provide all the necessary components to begin a model driven engineering project \citep{epsilonWebsite}. From the Epsilon Website \citep{epsilonWebsite}, the languages that are provided by Epsilon are:
